...
interface BrushstrokeButtonProps
	extends React.ButtonHTMLAttributes<HTMLButtonElement>, BrushstrokeStyles {}

export function BrushstrokeButton({
	inkColor,
	textColor,
	size,
	className,
	children,
	...props
}: BrushstrokeButtonProps) {
	void size
	return (
		<button
			className={BrushstrokeVariants({
				inkColor,
				textColor,
				interactive: true,
				className,
