...
function GeneralCompetenciesStatisticsBox({
	title,
	graph,
	period,
	setPeriod,
...
function SpecificCompetenciesStatisticsBox({
	title,
	graph,
	skills,
	selectedSkill,
...
export default function Statistics() {
	...
	useEffect(() => {
		...
		loadTimelineStats()
	}, [timelinePeriod, timelineLevel, getTimeLine])
			...
			<div className='relative z-50 w-full flex flex-col justify-center items-center'>
				<div className='flex flex-col justify-center items-center w-full min-[700px]:max-w-[700px] min-[1200px]:max-w-full gap-5'>
					...
					<div className='flex flex-col justify-center items-center w-full'>
						<MainButton
							title='Progresso por competências'
							active={competencyOpen}
							setActive={setCompetencyOpen}
						/>
						<div
							className={`grid grid-cols-1 place-items-center sm:place-items-start gap-1 w-full min-[1200px]:grid-cols-2
